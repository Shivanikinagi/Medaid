...
const LoginPage: React.FC = () => {
  ...
  const handleGoogleLogin = () => {
    ...
    try {
      ...
      setError(err.message || 'Google login is not configured. Please contact support.');
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-900 p-12 flex-col justify-between relative overflow-hidden">
        ...
        {/* Decorative Elements */}
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-500 rounded-full filter blur-3xl opacity-20 -translate-x-1/2 translate-y-1/2"></div>
        <div className="absolute top-1/4 right-0 w-64 h-64 bg-indigo-500 rounded-full filter blur-3xl opacity-20 translate-x-1/2"></div>
      </div>
        ...
        >
          ...
          <div className="mb-6">
            <button
              ...
              disabled={loading}
              type="button"
              className="w-full flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-800 border border-gray-800 rounded-xl py-3 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
